...
void main(void)
{
    ...
    while (1)
    {
        LumTx.lum = ADC_GetConversion(0);
        LumTx.lum = LumTx.lum*gainLumRx.gainLum;
        TempTx.temp = ADC_GetConversion(1);
