...
# 46 "./mcc_generated_files/system/../adc/adc.h"
...
# 83 "./mcc_generated_files/system/../adc/adc.h"
void ADC_Initialize(void);
# 92 "./mcc_generated_files/system/../adc/adc.h"
...
# 1 "./mcc_generated_files/system/../pwm/eccp2.h" 1
# 58 "./mcc_generated_files/system/../pwm/eccp2.h"
void ECCP2_Initialize(void);
# 67 "./mcc_generated_files/system/../pwm/eccp2.h"
void ECCP2_LoadDutyValue(uint16_t dutyValue);
# 45 "./mcc_generated_files/system/system.h" 2

# 1 "./mcc_generated_files/system/../fvr/fvr.h" 1
# 61 "./mcc_generated_files/system/../fvr/fvr.h"
 void FVR_Initialize(void);
# 71 "./mcc_generated_files/system/../fvr/fvr.h"
_Bool FVR_IsOutputReady(void);
# 46 "./mcc_generated_files/system/system.h" 2

# 1 "./mcc_generated_files/system/../timer/tmr1.h" 1
# 39 "./mcc_generated_files/system/../timer/tmr1.h"
# 1 "./mcc_generated_files/system/../timer/timer_interface.h" 1
# 43 "./mcc_generated_files/system/../timer/timer_interface.h"
...
# 39 "./mcc_generated_files/system/../timer/tmr1.h" 2
...
# 56 "./mcc_generated_files/system/../timer/tmr1.h"
void TMR1_Initialize(void);
# 65 "./mcc_generated_files/system/../timer/tmr1.h"
void TMR1_Start(void);
# 74 "./mcc_generated_files/system/../timer/tmr1.h"
void TMR1_Stop(void);
# 83 "./mcc_generated_files/system/../timer/tmr1.h"
uint16_t TMR1_Read(void);
# 92 "./mcc_generated_files/system/../timer/tmr1.h"
static void TMR1_Write(size_t timerVal);
# 101 "./mcc_generated_files/system/../timer/tmr1.h"
...
# 118 "./mcc_generated_files/system/../timer/tmr1.h"
void TMR1_StartSinglePulseAcquisition(void);
# 127 "./mcc_generated_files/system/../timer/tmr1.h"
...
# 153 "./mcc_generated_files/system/../timer/tmr1.h"
...
static uint16_t ldr_voltage;


void inc_dec(void)
{
    static uint16_t pwm_duty = 0;
    if(pwm_duty < ldr_voltage)
    {
        pwm_duty = pwm_duty + 2;
    ...
    ECCP2_LoadDutyValue(pwm_duty);
}

int main(void)
{
    SYSTEM_Initialize();
    TMR1_OverflowCallbackRegister(inc_dec);
    ...
    while(1)
    {
        ldr_voltage = ADC_GetConversion(channel_AN1);
