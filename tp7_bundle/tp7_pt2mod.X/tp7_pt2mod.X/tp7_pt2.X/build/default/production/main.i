...
# 1 "./mcc_generated_files/system/../capture/eccp1.h" 1
# 46 "./mcc_generated_files/system/../capture/eccp1.h"
...
# 75 "./mcc_generated_files/system/../capture/eccp1.h"
_Bool ECCP1_IsCapturedDataReady(void);
# 84 "./mcc_generated_files/system/../capture/eccp1.h"
...
# 136 "./mcc_generated_files/system/../timer/tmr1.h"
...
int main(void)
{
    ...
    while(1)
    {
        ...
        inc_dec();
        if (ECCP1_IsCapturedDataReady()) {
            rpm = 60/(0.000016*ECCP1_CaptureRead());
        }
        else {
            rpm = rpm;
        }
