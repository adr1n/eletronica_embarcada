...
global den
global quoc ;Registrador do PORTA
global rest
global i ;contador
...
ORG 0x100 ;Aloca o código no endereço 0x100
 ...
 movwf TRISB
 movwf TRISD
 movlw 0x01 ;Setando PORTE com ((PORTE) and 07Fh), 0 como entrada e ((PORTE) and 07Fh), 1 como saída
 movwf TRISE
 ...
 goto div_shift ;((PORTE) and 07Fh), 0=0: Subtrações sucessivas, ((PORTE) and 07Fh), 0=1: Subtração e deslocamento
 call div_sub
 call show_result
 goto get_values
